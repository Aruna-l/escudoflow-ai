...
import {
  AI_FINDINGS, ALERTS, ATTACK_CATEGORIES, DAILY_INVESTIGATIONS, DASHBOARD_KPIS,
  RECENT_INVESTIGATIONS, RECOMMENDATIONS, RISK_DISTRIBUTION, THREAT_SOURCES, THREAT_TREND,
} from "@/lib/mock-data";
    ...
    <AppShell>
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-3">
        <GlassCard className="lg:col-span-2 min-h-[320px]">
          <SectionHeading title="Threat Trends" description="Detected vs. blocked, last 14 days" action={<RiskBadge level="suspicious" label="Elevated" />} />
          <div className="h-64">
            <ResponsiveContainer>
        ...
        <GlassCard className="min-h-[320px]">
          ...
          <div className="h-64">
            <ResponsiveContainer>
              <PieChart>
                <Pie data={ATTACK_CATEGORIES} dataKey="value" nameKey="name" innerRadius={45} outerRadius={80} paddingAngle={3}>
                  {ATTACK_CATEGORIES.map((_, i) => <Cell key={i} fill={CHART_COLORS[i % CHART_COLORS.length]} />)}
                </Pie>
                <Tooltip contentStyle={{ background: "#0B1120", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 8 }} />
              </PieChart>
            </ResponsiveContainer>
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-3">
        <GlassCard className="min-h-[280px]">
          ...
          <div className="h-56">
            <ResponsiveContainer>
              <BarChart data={DAILY_INVESTIGATIONS}>
                <CartesianGrid stroke="rgba(255,255,255,0.06)" vertical={false} />
                <XAxis dataKey="day" stroke="rgba(255,255,255,0.4)" fontSize={11} />
                <YAxis stroke="rgba(255,255,255,0.4)" fontSize={11} />
                <Tooltip contentStyle={{ background: "#0B1120", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 8 }} />
        ...
        <GlassCard className="min-h-[280px]">
          ...
          <div className="h-56">
            <ResponsiveContainer>
              <BarChart data={THREAT_SOURCES} layout="vertical">
